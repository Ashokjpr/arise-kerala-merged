...
import { fmgeTestDiscussionCourse } from "../_data/cources/CourcesData";
import Link from "next/link";
import AOS from "aos";
import "aos/dist/aos.css";

export default function FMGETestDiscussionCourse() {
  return (
    <>
      <main className="w-full overflow-hidden pb-24">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            {fmgeTestDiscussionCourse.hero.title}
          </h1>

          <Link
            href={fmgeTestDiscussionCourse.hero.cta.link}
            ...
            data-aos-delay="200"
          >
            {fmgeTestDiscussionCourse.hero.cta.label} →
          </Link>
        </section>
        ...
        >
          <h2 className="text-3xl font-bold mb-4">
            {fmgeTestDiscussionCourse.courseDetails.heading}
          </h2>

          <p className="text-gray-700 leading-relaxed mb-8">
            {fmgeTestDiscussionCourse.courseDetails.description}
          </p>

          {/* HIGHLIGHTS */}
          <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {fmgeTestDiscussionCourse.highlights.map((item, index) => (
              <li
                key={index}
